...
DECLARE_DYNAMIC_DELEGATE_OneParam(FOnJoinButtonClicked, const USNSessionSearchResult*, SearchResult);
...
public:
	...
	//! @{@name ルーム情報を表示
	USNMatchingTestRoomItem* ShowRoomItem(const FString& SessionName, int ConnectionNum, USNSessionSearchResult* SearchResult);
	//! @}
